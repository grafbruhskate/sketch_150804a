...
void setup() {
  ...
  PImage friends = loadImage("250aaronhomoki_team.jpg");  // 2. Change this to match the name of your photo. 
...
background(friends);
  ...
  mustache = loadImage("free vintage image_mustache.png"); // 5. Change this to match your file name.
}
